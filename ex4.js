...
function tieneTextoBallena(item) {
    return item.text.includes("Ballena");
}

console.log(items.some(tieneTextoBallena));
...
function tieneTagES6(item) {
    return item.Tags.includes("ES6");
}

  console.log(items.some(tieneTagES6)); // true
